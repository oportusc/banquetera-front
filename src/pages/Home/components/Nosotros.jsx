...
const Nosotros = () => {
  return (
    <section id="nosotros" className="min-h-[50vh] bg-black text-white py-12 sm:mt-10">
      <div className="max-w-6xl mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className='flex flex-col gap-8 text-center'>
            <h2 className="text-7xl text-center font-pinyon text-amber-500 font-medium leading-none">¿Quiénes Somos?</h2>
            <p className="text-cream-200 leading-relaxed text-lgt">
